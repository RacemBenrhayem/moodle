...
$string['iprestriction_help'] = 'The user will need to call the web service from the listed IPs (separated by commas). Valid entries are a full IP address (such as 192.168.10.1 or fe80::1111), a partial address (such as 192.168 or fe80:1111) which matches any address starting with those numbers, CIDR notation (such as 231.54.211.0/20 or fe80::/64), or a range applying to the last part of the address (such as 231.3.56.10-20 or fe80::1111-bbbb). Domain names are not supported.';
$string['iprestrictioninvalid'] = 'These IP restrictions are invalid: {$a}';
$string['key'] = 'Key';
